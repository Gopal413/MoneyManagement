...
//   <div className="bg-white w-[1000px] p-8 rounded-xl shadow-lg">
...
//       <div className="flex items-center gap-4 bg-cyan-100 p-4 rounded-lg">
//         <div className="bg-cyan-400 text-white p-3 rounded-full">₹</div>
//         <div>
//           <p className="text-gray-600">Your Income</p>
//           <p className="text-xl font-semibold">Rs {income}</p>
//         </div>
//       </div>

//       <div className="flex items-center gap-4 bg-purple-100 p-4 rounded-lg">
//         <div className="bg-purple-400 text-white p-3 rounded-full">₹</div>
//         <div>
//           <p className="text-gray-600">Your Expenses</p>
//           <p className="text-xl font-semibold">Rs {expenses}</p>
//         </div>
//       </div>
...
//                     onClick={()=>setstore(pre=>pre.filter(each=>each.id!==value.id))}
//                   >
//                     Delete
//                   </button>
//                 </td>
